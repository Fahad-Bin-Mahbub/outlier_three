					...
					<div className="w-full md:w-auto mb-3 md:mb-0">
						...
						<div className="relative inline-block w-full md:w-auto">
							<select
								...
								className="w-full md:w-56 lg:w-64 appearance-none block px-3 text-black sm:px-4 py-2 sm:py-2.5 border border-blue-300 rounded-md shadow-sm bg-white bg-opacity-90 backdrop-blur-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 cursor-pointer text-xs sm:text-sm"
							>
								{employees.map((emp) => (
